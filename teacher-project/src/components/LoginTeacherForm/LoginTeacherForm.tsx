...
import styles from "./LoginTeacherForm.module.scss";
import { Link } from "react-router-dom";
import { ROUTES } from "../../constants/routes";
import { InputError } from "../InputError/InputError";

export function LoginTeacherForm(): JSX.Element {
    const {
        register,
        handleSubmit,
        formState: { errors },
    ...
    return (
        <form
            ...
            className={styles.loginTeacherForm}
        >
            <div className={styles.header}>
                <h1>Увійти як викладач</h1>
            </div>
            ...
            <div className={styles.bottomBlock}>
                ...
                <div className={styles.bottomNav}>
                    ...
                    <p>або</p>
                    <Link to={ROUTES.LOGIN}>увійти як студент</Link>
                </div>
            </div>
        </form>
    );
